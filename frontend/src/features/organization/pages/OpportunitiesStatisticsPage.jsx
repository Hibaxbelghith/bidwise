...
import { Briefcase, Users, Eye, Calendar, TrendingUp } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (!isCancelled) {
          setError(err?.response?.data?.detail || t('organization.unableLoadPublishedOpportunities'));
        }
      } finally {
        if (!isCancelled) {
          setIsLoading(false);
    ...
    return (
      <section className="flex min-h-[70vh] items-center justify-center bg-white px-4">
        <div className="flex items-center gap-3 rounded-lg border border-gray-200 bg-white px-5 py-4 text-sm text-gray-600">
          ...
          {t('organization.loadingStatistics')}
        </div>
      </section>
    );
  }
          ...
          <div className="p-6">
            ...
            {isLoading ? (
              <div className="flex min-h-[400px] items-center justify-center">
                <div className="flex items-center gap-3 rounded-lg border border-gray-200 bg-white px-5 py-4 text-sm text-gray-600">
                  <Spinner size={16} className="text-blue-600" />
                  {t('organization.loadingYourStatistics')}
                </div>
              </div>
              ...
              <div className="flex min-h-[400px] flex-col items-center justify-center text-center">
                ...
                <p className="text-gray-600">{t('organization.noOpportunitiesYet')}</p>
                <p className="mt-1 text-sm text-gray-400">
                  {t('organization.createFirstOpportunityStats')}
                </p>
              </div>
            ) : (
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                  <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-gray-500">{t('organization.totalOpportunities')}</p>
                    ...
                    <div className="mt-3 text-xs text-gray-400">
                      {t('organization.activeCount', { count: stats.activeOpportunities })}
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-gray-500">{t('organization.totalApplications')}</p>
                    ...
                    <div className="mt-3 text-xs text-gray-400">
                      {t('organization.acrossAllOpportunities')}
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-gray-500">{t('organization.newApplications')}</p>
                  ...
                  <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="text-sm text-gray-500">{t('organization.profileViews')}</p>
                    ...
                    <div className="mt-3 text-xs text-gray-400">
                      {t('organization.totalImpressions')}
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-lg border border-gray-200 bg-white overflow-hidden">
                  <div className="border-b border-gray-100 bg-white px-5 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <h2 className="text-base font-medium text-gray-900">{t('organization.mostPopularOpportunity')}</h2>
                    </div>
                  </div>
                  <div className="p-5">
