...
const OpportunityAssistantLoader = () => (
  <div className="flex items-center gap-3">
    ...
    <span className="text-sm text-gray-600">BidWise AI is reviewing the available details</span>
  </div>
);
  ...
  return (
    ...
    >
      <div className="flex items-end gap-2 rounded-lg border border-gray-200 bg-white px-3 py-2 shadow-sm transition-colors focus-within:border-blue-400 focus-within:ring-1 focus-within:ring-blue-100">
        ...
        >
          {loading ? <Loader2 className="h-4 w-4 bidwise-force-spin text-blue-600" /> : <Send className="h-4 w-4" />}
        </button>
      </div>
